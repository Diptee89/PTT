...
import pages.ApproveFormA;
import pages.ApproveImmigration;
import pages.ApprovePANS;
import pages.ApprovePKP;
import pages.ArriveJourney;
import pages.CancelledSAD;
...
//	@Test(priority = 6)
//	public static void approvePANS() throws Throwable {
//
//		File f = new File(propFilePath);
//		FileInputStream is = new FileInputStream(f);
//		Properties prop = new Properties();
//		prop.load(is);
//
//		ApprovePANS obj = PageFactory.initElements(OR.driver, ApprovePANS.class);
//
//		excelUtils = new ExcelUtils();
//		Method[] meth = obj.getClass().getDeclaredMethods(); // Return all methods in an array
//
//		ExcelUtils.setExcelFile(prop.getProperty("Path"), prop.getProperty("ApprovePANSSheet"));
//		nRows = ExcelUtils.getRowCount(prop.getProperty("ApprovePANSSheet"));
//
//		System.out.println("Nubmer Of Methods: " + meth.length + " | Number of Rows: " + nRows);
//
//		for (int i = 1; i < nRows; i++) {
...
//
//	@Test(priority = 7)
//	public static void approvePKPForm() throws Throwable {
//
//		File f = new File(propFilePath);
//		FileInputStream is = new FileInputStream(f);
//		Properties prop = new Properties();
//		prop.load(is);
//
//		ApprovePKP obj = PageFactory.initElements(OR.driver, ApprovePKP.class);
//
//		excelUtils = new ExcelUtils();
//		Method[] meth = obj.getClass().getDeclaredMethods(); // Return all methods in an array
//
//		ExcelUtils.setExcelFile(prop.getProperty("Path"), prop.getProperty("ApprovePKPSheet"));
//		nRows = ExcelUtils.getRowCount(prop.getProperty("ApprovePKPSheet"));
//		System.out.println("Nubmer Of Methods: " + meth.length + " | Number of Rows: " + nRows);
//
//		for (int i = 1; i < nRows; i++) {
//			String Keyword = ExcelUtils.getCellData(i, 3); // Action_Keyword
...
//		Method[] meth = obj.getClass().getDeclaredMethods(); // Return all methods in an array
//
//		ExcelUtils.setExcelFile(prop.getProperty("Path"), prop.getProperty("ApproveFAL1Sheet"));
//		nRows = ExcelUtils.getRowCount(prop.getProperty("ApproveFAL1Sheet"));
//
//		System.out.println("Nubmer Of Methods: " + meth.length + " | Number of Rows: " + nRows);
//
//		for (int i = 1; i < nRows; i++) {
...
//		Method[] meth = obj.getClass().getDeclaredMethods(); // Return all methods in an array
//
//		ExcelUtils.setExcelFile(prop.getProperty("Path"), prop.getProperty("ApproveImmigrationSheet"));
//		nRows = ExcelUtils.getRowCount(prop.getProperty("ApproveImmigrationSheet"));
//
//		System.out.println("Nubmer Of Methods: " + meth.length + " | Number of Rows: " + nRows);
//
//		for (int i = 1; i < nRows; i++) {
...
//
//	@Test(priority = 10)
//	public static void approveFormA() throws Throwable {
//		File f = new File(propFilePath);
//		FileInputStream is = new FileInputStream(f);
//		Properties prop = new Properties();
//		prop.load(is);
//
//		ApproveFormA obj = PageFactory.initElements(OR.driver, ApproveFormA.class);
//
//		excelUtils = new ExcelUtils();
//		Method[] meth = obj.getClass().getDeclaredMethods(); // Return all methods in an array
//
//		ExcelUtils.setExcelFile(prop.getProperty("Path"), prop.getProperty("ApproveFormASheet"));
//		nRows = ExcelUtils.getRowCount(prop.getProperty("ApproveFormASheet"));
//
//		System.out.println("Nubmer Of Methods: " + meth.length + " | Number of Rows: " + nRows);
//
//		for (int i = 1; i < nRows; i++) {
...
//
//	@Test(priority = 12)
//	public static void CancelSAD() throws Throwable {
//		File f = new File(propFilePath);
//		FileInputStream is = new FileInputStream(f);
//		Properties prop = new Properties();
//		prop.load(is);
//
//		CancelledSAD obj = PageFactory.initElements(OR.driver, CancelledSAD.class);
//
//		excelUtils = new ExcelUtils();
//		Method[] meth = obj.getClass().getDeclaredMethods(); // Return all methods in an array
//
//		ExcelUtils.setExcelFile(prop.getProperty("Path"), prop.getProperty("CancelSADSheet"));
//		nRows = ExcelUtils.getRowCount(prop.getProperty("CancelSADSheet"));
//
//		System.out.println("Nubmer Of Methods: " + meth.length + " | Number of Rows: " + nRows);
//
//		for (int i = 1; i < nRows; i++) {
