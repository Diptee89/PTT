...
public class CargoImport {
	...
	public static String portOfArrival;
	// ------------------------------------------Login------------------------------------
	...
	@FindBy(xpath = ".//*[@id='txtArrivalPort']")
	static WebElement txtArrivalPort;
	@FindBy(xpath = ".//*[@id='autocompletediv']/li/a")
	static WebElement autocompletediv;
	@FindBy(xpath = "//button[text()='New']")
	static WebElement btnNew;
	@FindBy(xpath = ".//*[@id='OriginPort']")
	static WebElement txtOriginPort;
	@FindBy(xpath = ".//*[@id='LastPortOfCall']")
	static WebElement txtLastPortOfCall;
	@FindBy(xpath = ".//*[@id='NextPortOfCall']")
	...
	public CargoImport(WebDriver driver) {
...
//============Create Import Journey
	public static void setArrivalPort(String testData) {
		try {
			// ----------Switch to main iframe--------------
			

			// ----------Import Journey New ------------
			txtArrivalPort.clear();
			txtArrivalPort.sendKeys(testData);
			autocompletediv.click();
			
			portOfArrival=txtArrivalPort.getAttribute("value");
			System.out.println(txtArrivalPort.getAttribute("irmsg"));
		} catch (Exception e) {
			System.out.println(e.getMessage());
			Driver_Class.testResult = false;
	...
	public static void setOriginPort(String testData) {
		try {
			txtOriginPort.clear();
			txtOriginPort.sendKeys(testData);
			autocompletediv.click();
			portOfOrigin=txtOriginPort.getAttribute("value");
			System.out.println(txtOriginPort.getAttribute("irmsg"));
		} catch (Exception e) {
			System.out.println(e.getMessage());
			Driver_Class.testResult = false;
	...
	public static void setLastPortOfCall(String testData) {
		try {
			txtLastPortOfCall.sendKeys(testData);
			autocompletediv.click();
			System.out.println(txtLastPortOfCall.getAttribute("irmsg"));
		} catch (Exception e) {
			System.out.println(e.getMessage());
			Driver_Class.testResult = false;
	...
	public static void clickLastPortOfCallATA_Date(String testData) {
		try {
			txtLastPortOfCallATADatePicker.click();
			// btnToday.click();
		} catch (Exception e) {
			System.out.println(e.getMessage());
			Driver_Class.testResult = false;
	...
	public static void selectATA_Hrs(String testData) {
		try {

			Select hrs = new Select(ddlLastPortOfCallATAHrs);
	...
	public static void selectATA_Mins(String testData) {
		try {

			Select mins = new Select(ddlLastPortOfCallATAMin);
	...
	public static void clickLastPortOfCallATD_Date(String testData) {
		try {
			txtLastPortOfCallATDDatePicker.click();
			// btnToday.click();
		} catch (Exception e) {
			System.out.println(e.getMessage());
			Driver_Class.testResult = false;
	...
	public static void selectATD_Hrs(String testData) {
		try {

			Select hrs = new Select(ddlLastPortOfCallATDHrs);
			hrs.selectByVisibleText(testData);
		} catch (Exception e) {
			System.out.println(e.getMessage());
			Driver_Class.testResult = false;
	...
	public static void selectATD_Mins(String testData) {
		try {

			Select mins = new Select(ddlLastPortOfCallATDMin);
			mins.selectByVisibleText(testData);
		} catch (Exception e) {
			System.out.println(e.getMessage());
			Driver_Class.testResult = false;
	...
	public static void setLastPortOfCallVoyageNo(String testData) {
		try {
			txtLastPortOfCallVoyageNo.sendKeys(testData);
		} catch (Exception e) {
			System.out.println(e.getMessage());
			Driver_Class.testResult = false;
	...
	public static void setLastPortOfCallPurposeOfCall(String testData) {
		try {
			Select purposeOfCall = new Select(ddlLastPortOfCallPurposeOfCall);
			purposeOfCall.selectByVisibleText(testData);
		} catch (Exception e) {
			System.out.println(e.getMessage());
			Driver_Class.testResult = false;
	...
	public static void setLastPortOfCallISPS(String testData) {
		try {
			Select ISPSLevel = new Select(ddlLastPortOfCallISPS);
			ISPSLevel.selectByVisibleText(testData);
		} catch (Exception e) {
			System.out.println(e.getMessage());
			Driver_Class.testResult = false;
	...
	public static void clickExpectedArrival(String testData) {
		try {
	...
	public static void selectExpectedArrival_Hrs(String testData) {
		try {
			Select hrs = new Select(ddlExpectedArrivalDateHrs);
			hrs.selectByVisibleText(testData);
	...
	public static void selectExpectedArrival_Mins(String testData) {
		try {

			Select mins = new Select(ddlExpectedArrivalDateMins);
			mins.selectByVisibleText(testData);
		} catch (Exception e) {
			System.out.println(e.getMessage());
			Driver_Class.testResult = false;
...
//			 txtShipName.sendKeys("RAINBOW"); 
			txtShipName.sendKeys("11RMS Amethyst8961");
//			 txtShipName.sendKeys("%%"+VesselRegistration.shipName);
	...
	public static void setVoyageNo(String testData) {
		try {
			JavascriptExecutor jse = (JavascriptExecutor) OR.driver;
			jse.executeScript("window.scrollBy(0,400)");
			...
			txtVoyageNo.sendKeys(testData + value); // Voyage Number
			voyageNumber= testData + value;
			System.out.println("Voyage No: "+ voyageNumber);
		} catch (Exception e) {
			System.out.println(e.getMessage());
			Driver_Class.testResult = false;
	...
	public static void setBerthAlongside(String testData) {
		try {
			txtBerthalong.sendKeys(testData); // Berth Alongside
		} catch (Exception e) {
			System.out.println(e.getMessage());
			Driver_Class.testResult = false;
...
static WebElement txtShipCallNo;
	public static void clickSubmit_JourneyBtn(String testData) {
		try {
			...
			JourneyNo = journeyNo.getText();
			System.out.println("Import Journey no. from Journey screen: " + JourneyNo);
			...
			vesselId= txtVesselId.getAttribute("value");
			iMONumber =txtIMONumber.getAttribute("value");
			shipName= txtShipName.getAttribute("value");
			shipCallNo= txtShipCallNo.getAttribute("value");
			System.out.println("Vessel Identification No.: "+vesselId+", IMO Number: "+iMONumber+", Ship Name/Vessel Name: "+shipName+", Ship Call No. (SCN): "+shipCallNo);
//			Thread.sleep(2000);		
		} catch (Exception e) {
			System.out.println(e.getMessage());
			Driver_Class.testResult = false;
