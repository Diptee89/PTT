package pages;
	...
	import org.openqa.selenium.By;
		...
		public class Create_Journey {
			...
			static @FindBy(xpath="//*[@id=\"txtArrivalPort\"]") WebElement ActivatePort;
			...
			static @FindBy(xpath="//*[@id=\"ExpectedArrivalDateDatePicker\"]") WebElement DateforArrived;
...
//			static @FindBy(xpath="//*[@id=\"quantitylanded\"]") WebElement quantitylanded;
			...
			//*[@id="normalbutton1"]
			 ...
			 public Create_Journey(WebDriver driver){
...
//			        
			...
			public static void OrginPort1(String strOrginPort) {
				try {
					Thread.sleep(2000);
					OrginPort.sendKeys(strOrginPort);
					linkAutocomplete1.click();
				} catch (Exception e) {
					e.getMessage();
				}
			...
			public static void DateforArrived1() {
				try {
					...
					OR.driver.findElement(By.xpath("//*[@id=\"ui-datepicker-div\"]/table/tbody/tr[4]/td[4]/a")).click();
				} catch (Exception e) {
					e.getMessage();
				}
