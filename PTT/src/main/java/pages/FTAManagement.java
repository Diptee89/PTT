...
//			txtAgreementName.sendKeys(testData);
			txtAgreementName.sendKeys("%%");
			Thread.sleep(3000);
			System.out.println("AgreementName: " + AgreementNameTypes.AgreementName);
			
			txtAgreementName.sendKeys(AgreementNameTypes.AgreementName);  //get Agreement Name from AgreementNameTypes class
	...
	public static void clickCreatebttn(String testData) {
		try {
			...
			System.out.println("Request Number from FTA MANAGEMENT: " + FTARequestNo);
		} catch (Exception e) {
			System.out.println(e.getMessage());
			PTTDriverClass.testResult = false;
...
//			txtAgreementNamesearch.sendKeys(testData);
			...
			txtAgreementNamesearch.sendKeys(AgreementNameTypes.AgreementName);
		} catch (Exception e) {
			System.out.println(e.getMessage());
			PTTDriverClass.testResult = false;
